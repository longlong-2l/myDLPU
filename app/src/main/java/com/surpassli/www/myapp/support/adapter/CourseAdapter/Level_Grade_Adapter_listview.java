 ...
 */
public class Level_Grade_Adapter_listview extends BaseAdapter {

    private List<Level_Grade> mCourse_table_been_list;
    private LayoutInflater mInflater;

    public Level_Grade_Adapter_listview(Context context, List<Level_Grade> mCourse_table_been) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Level_Grade myListBean = mCourse_table_been_list.get(position);
